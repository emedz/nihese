...
<a href="/datapetugas/create" class="btn btn-secondary mb-3">Add Officer</a>
    ...
    <table class="table table-striped table-sm">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <button class="btn border-0 btn-warning"><a href="{{route('datapetugas.edit', $user->id)}}"><img src="/img/edit.svg" class="logo" alt="" srcset=""></a></button>
