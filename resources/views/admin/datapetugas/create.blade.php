...
<h1>Create New Officer</h1>

<form method="POST" action="/datapetugas">
  @csrf
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control @error('') is-invalid @enderror" id="level" name="level" value="petugas">
  </div>
